...
public class PRC_CORE {
	...
	// public void CORE_RUN(PRC_XMLOUT xmlout, LBR robot, Controller kuka_Sunrise_Cabinet_1, SpatialObject tool, String tcpname, ObjectFrame baseFrame, boolean enablelogging, ITaskLogger logger, MobilePlatform miiwa, IApplicationData AppData, AbstractIOGroup ioGroup) {
		...
		if (enablelogging){
			...
			iApplicationUI.displayModalDialog(ApplicationDialogType.INFORMATION, "tool.getName(): " + tool.getName() + 
			"\nrobot.getFlange().toString():" + robot.getFlange().toString() 
			+ "\ntool.getFrame(tcpname): " + tool.getFrame(tcpname)
			+ "\ntcpname: " + tcpname
			+ "\nactTCP: " + actTCP, "OK");
		}
			...
			if (cmd.prccmdType.equals(PRC_Enums.ANOUT)){
				if (motionContainers.size() > 0){
					...
					if (enablelogging){
						...
						iApplicationUI.displayModalDialog(ApplicationDialogType.INFORMATION, "PRC_Enums.ANOUT " + returnstr, "OK");
					}
				...
				if (enablelogging){
					...
					iApplicationUI.displayModalDialog(ApplicationDialogType.INFORMATION, "PRC_Enums.AXIS " + cmd.axisMove.ToString(), "OK");
				}
				...
				if (enablelogging){
					// logger.info(returnstr);
					iApplicationUI.displayModalDialog(ApplicationDialogType.INFORMATION, "PRC_Enums.DIGOUT " + returnstr, "OK");
				}
				...
				if (enablelogging){
					...
					iApplicationUI.displayModalDialog(ApplicationDialogType.INFORMATION, "PRC_Enums.KMRMOVE " + cmd.kmrMove.ToString(), "OK");
				}
				...
				if (enablelogging){
					...
					iApplicationUI.displayModalDialog(ApplicationDialogType.INFORMATION, "PRC_Enums.CIR " + cmd.cirMove.ToString(), "OK");
				}
				...
				if (enablelogging){
					...
					iApplicationUI.displayModalDialog(ApplicationDialogType.INFORMATION, "PRC_Enums.LIN " + cmd.linMove.ToString(), "OK");
				}
				...
				if (enablelogging){
					...
					iApplicationUI.displayModalDialog(ApplicationDialogType.INFORMATION, "PRC_Enums.LINCOMP " + cmd.linCompMove.ToString(), "OK");
				}
				...
				if (enablelogging){
					...
					iApplicationUI.displayModalDialog(ApplicationDialogType.INFORMATION, "PRC_Enums.PTP " + cmd.ptpMove.ToString(), "OK");
				}
				...
				if (enablelogging){
					...
					iApplicationUI.displayModalDialog(ApplicationDialogType.INFORMATION, "PRC_Enums.PTPCOMP " + cmd.ptpCompMove.ToString(), "OK");
				}
				...
				if (enablelogging){
					...
					iApplicationUI.displayModalDialog(ApplicationDialogType.INFORMATION, "PRC_Enums.WAIT " + cmd.wait.ToString(), "OK");
				}
				...
				if (enablelogging){
					...
					iApplicationUI.displayModalDialog(ApplicationDialogType.INFORMATION, "PRC_Enums.MBATCH " + cmd.motionBatch.ToString(), "OK");
				}
				...
				if (enablelogging){
					...
					iApplicationUI.displayModalDialog(ApplicationDialogType.INFORMATION, "PRC_Enums.SPL " + cmd.splMove.ToString(), "OK");
				}
			} 
