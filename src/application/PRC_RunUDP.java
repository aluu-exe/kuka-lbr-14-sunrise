...
public class PRC_RunUDP extends RoboticsAPIApplication {
	...
	public void run() {
		...
		try {
			prc_udp.CORE_UDP(robot, kuka_Sunrise_Cabinet_1, getApplicationData().createFromTemplate(toolname), tcpname, baseFrame, enablellogging, getApplicationData(), iogrp, "172.31.1.149", 49152);
